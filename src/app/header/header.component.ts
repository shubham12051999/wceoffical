...
export class HeaderComponent implements OnInit {
  @Input()ha=new TestsTypeComponent(this.roter,this.http,this.wce);hb=new StudyAbroadCityComponent(this.roter,this.http,this.wce);hc=new StudyToursCityComponent(this.roter,this.http,this.wce);hd=new InternshipCityComponent(this.roter,this.http, this.wce);
